...
#define NAVIA_PROFILE 0
#if NAVIA_PROFILE
	#define NAVIA_PROFILE_BEGIN_SESSION(name, filepath) ::Navia::Instrumentor::Get().BeginSession(name, filepath)
	#define NAVIA_PROFILE_END_SESSION() ::Navia::Instrumentor::Get().EndSession()
